// src/pages/medicalDirector/ManageReferrals.jsx
...
export default function ManageReferrals() {
  ...
  const fetchReferrals = async () => {
    try {
      const res = await medicalDirectorService.getAllReferrals();
  ...
  const handleSaveEdit = async (id) => {
    try {
      ...
      await medicalDirectorService.patchReferral(id, editData);
      setEditingId(null);
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await medicalDirectorService.deleteReferral(id);
      fetchReferrals();
    } catch (err) {
  ...
  const handleViewDetail = (id) => {
    navigate(`/medical-director/referrals/${id}`);
  };
